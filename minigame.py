    ...
    while game_running and score<8:
        ...
        for i in range(len(history)):
            for j in range(len(temp)):
                print(history[i][j], end='')
            print('\n')
            
        temp = []
        for i in range(len(data)):
            if data[i][0] == "MATCH":
                char = f'{Style.BRIGHT}{Fore.BLACK}{Back.GREEN}{data[i][1]}{Style.RESET_ALL}'
                print(char, end= '')
            elif data[i][0] == "PRESENT":
                char = f'{Style.BRIGHT}{Fore.BLACK}{Back.YELLOW}{data[i][1]}{Style.RESET_ALL}'
                print(char, end= '')
            elif data[i][0] == "MISSING":
                char = f'{Style.BRIGHT}{Fore.BLACK}{Back.RED}{data[i][1]}{Style.RESET_ALL}'
                print(char, end= '')
            temp.append(char)
        history.append(temp)
...
def instructions():
    ...
    word = 'AUDIO'
    for i in range(3):
        char = f'{Style.BRIGHT}{Fore.BLACK}{Back.GREEN}{word[i]}{Style.RESET_ALL}'
        print(char, end= '')
    for i in range(3,4):
        char = f'{Style.BRIGHT}{Fore.BLACK}{Back.RED}{word[i]}{Style.RESET_ALL}'
        print(char, end= '')
    for i in range(4,5):
        char = f'{Style.BRIGHT}{Fore.BLACK}{Back.YELLOW}{word[i]}{Style.RESET_ALL}'
        print(char, end= '')
    print()
    time.sleep(1)
